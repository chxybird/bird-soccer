    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="all-order-manage-list.html">球员管理</a></li>
        ...
        <section class="content">
            ...
            <div class="panel panel-default">
                ...
                <div class="row data-type">
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               value="${result.sexStr }" readonly="readonly">
                    </div>
                    <div class="col-md-2 title">年龄</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               value="${result.age }" readonly="readonly">
                    </div>
                    <div class="col-md-2 title">薪水</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               value="${result.salary }" readonly="readonly">
                    </div>
                    <div class="col-md-2 title">国籍</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               value="${result.country }" readonly="readonly">
                    </div>
                    <div class="col-md-2 title">身高</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               value="${result.height }" readonly="readonly">
                    </div>
                    <div class="col-md-2 title">体重</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               value="${result.weight }" readonly="readonly">
                    </div>
                    <div class="col-md-2 title">位置</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               value="${result.location }" readonly="readonly">
                    </div>
                    <div class="col-md-2 title">惯用脚</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               value="${result.foot}" readonly="readonly">
                    </div>
                </div>
            </div>
            <!--球员信息/-->
            ...
            <c:choose>
                ...
                <c:when test="${empty result.team}">
                    <h1 align="center">还未指定球队<a href="${pageContext.request.contextPath}/player/pointTeam?id=${result.id}">点我指定</a></h1>
                </c:when>
            </c:choose>
