...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                球场管理 <small>球场添加</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="${pageContext.request.contextPath}/index.jsp"><i
                        class="fa fa-dashboard"></i> 首页</a></li>
                <li><a
                        href="${pageContext.request.contextPath}/ground/findAll?page=1&size=5">球场管理</a></li>
                <li class="active">球场添加</li>
            </ol>
        </section>
        <!-- 内容头部 /-->

        <form action="${pageContext.request.contextPath}/ground/save"
              method="post">
            <!-- 正文区域 -->
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <select class="form-control select2" style="width: 100%"
                                    name="sex">
                                <option value="0" selected="selected">小型</option>
                                <option value="1">中型</option>
                                <option value="2">大型</option>
                                <option value="3">巨型</option>
                            </select>
                        </div>
                    </div>
                </div>
