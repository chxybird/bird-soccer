...
<div class="container">
    <div class="main">
        <div class="sideright">
            <div class="index">
                <form action="${pageContext.request.contextPath}/user/register" id="form" method="post">
