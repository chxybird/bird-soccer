        ...
        <section class="content">
            ...
            <div class="panel panel-default">
                ...
                <div class="row data-type">
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               value="${result.permissionName }" readonly="readonly">
                    </div>
                    <div class="col-md-2 title">URL</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               value="${result.url }" readonly="readonly">
                    </div>
                </div>
            </div>
            <!-- 当前权限信息 -->
            ...
            <!--所属角色信息-->
            <c:forEach items="${result.roles}" var="i">
                <div class="panel panel-default">
                    <div class="panel-heading">所属角色信息</div>
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control"
                                   value="${i.roleName}" readonly="readonly">
                        </div>
                        <div class="col-md-2 title">角色描述</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control"
                                   value="${i.description}" readonly="readonly">
                        </div>
                    </div>
                </div>
            </c:forEach>
