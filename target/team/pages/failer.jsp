			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown user user-menu"><a href="#"
					class="dropdown-toggle" data-toggle="dropdown"> <img
						src="${pageContext.request.contextPath}/img/soccer.jpg"
	...
	<section class="sidebar">
		...
		<div class="user-panel">
			<div class="pull-left image">
				<img src="${pageContext.request.contextPath}/img/soccer.jpg"
		...
		<ul class="sidebar-menu">
			...
			<li class="treeview"><a href="#"> <i class="fa fa-cube"></i>
				...
				<ul class="treeview-menu">
					...
					<li id="system-setting"><a
						href="${pageContext.request.contextPath}/player/findAll?page=1&size=5">
							<i class="fa fa-circle-o"></i> 球员管理
					</a></li>
					<li id="system-setting"><a
							href="${pageContext.request.contextPath}/coach/findAll?page=1&size=5">
						<i class="fa fa-circle-o"></i> 教练管理
					</a></li>
					<li id="system-setting"><a
							href="${pageContext.request.contextPath}/doctor/findAll?page=1&size=5">
						<i class="fa fa-circle-o"></i> 队医管理
					</a></li>
					<li id="system-setting"><a
							href="${pageContext.request.contextPath}/ground/findAll?page=1&size=5">
						<i class="fa fa-circle-o"></i> 球场管理
					</a></li>
