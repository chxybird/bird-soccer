    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a
                        href="">用户管理</a></li>
                <li class="active">解除角色</li>
            </ol>
        </section>
        <!-- 内容头部 /-->

        <form
                action="${pageContext.request.contextPath}/user/remove" method="post">
            <!-- 正文区域 -->
            <section class="content">
                ...
                <div class="box-tools text-center">
                    <button type="submit" class="btn bg-maroon">移除</button>
