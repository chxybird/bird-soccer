    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="all-order-manage-list.html">球队管理</a></li>
        ...
        <section class="content">
            ...
            <div class="panel panel-default">
                ...
                <div class="row data-type">
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               value="${result.boss }" readonly="readonly">
                    </div>
                    <div class="col-md-2 title">主场地址</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               value="${result.address }" readonly="readonly">
                    </div>
                </div>
            </div>
            <!-- 球队信息 -->
            ...
            <!--球员信息-->
            <c:forEach items="${result.playes}" var="i">
            <div class="panel panel-default">
                <div class="panel-heading">球员信息</div>
                <div class="row data-type">

                    <div class="col-md-2 title">球员编号</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               value="${i.id}" readonly="readonly">
                    </div>
                    <div class="col-md-2 title">姓名</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               value="${i.name}" readonly="readonly">
                    </div>
                    <div class="col-md-2 title">性别</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               value="${i.sexStr}" readonly="readonly">
                    </div>
                    <div class="col-md-2 title">年龄</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               value="${i.age}" readonly="readonly">
                    </div>
                    <div class="col-md-2 title">薪水</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               value="${i.salary}" readonly="readonly">
                    </div>
                    <div class="col-md-2 title">国籍</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               value="${i.country}" readonly="readonly">
                    </div>
                    <div class="col-md-2 title">身高</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               value="${i.height}" readonly="readonly">
                    </div>
                    <div class="col-md-2 title">体重</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               value="${i.weight}" readonly="readonly">
                    </div>
                    <div class="col-md-2 title">位置</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               value="${i.location}" readonly="readonly">
                    </div>
                    <div class="col-md-2 title">惯用脚</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               value="${i.foot }" readonly="readonly">
                    </div>
                </div>
            </div>
            </c:forEach>
            ...
            <!--教练信息-->
            <c:forEach items="${result.coaches}" var="i">
            <div class="panel panel-default">
                ...
                <div class="row data-type">
                    ...
                    <div class="col-md-2 title">能力</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               value="${i.abilityStr }" readonly="readonly">
                    </div>
                    <div class="col-md-2 title">类型</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               value="${i.typeStr }" readonly="readonly">
                    </div>
                    <div class="col-md-2 title">年龄</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
            ...
            <!--队医信息-->
            <c:forEach items="${result.doctors}" var="i">
            <div class="panel panel-default">
                <div class="panel-heading">队医信息</div>
                <div class="row data-type">
                    <div class="col-md-2 title">编号</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
            ...
            <!--球场信息-->
            <c:forEach items="${result.grounds}" var="i">
            <div class="panel panel-default">
                ...
                <div class="row data-type">
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               value="${i.city }" readonly="readonly">
                    </div>
                    <div class="col-md-2 title">容纳人数</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               value="${i.count }" readonly="readonly">
                    </div>
                    <div class="col-md-2 title">建造时间</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               value="${i.timeStr }" readonly="readonly">
                    </div>
